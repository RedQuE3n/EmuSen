...
*(Living document — updated as the toolchain grows. This revision adds the watchpoint mechanism and the generalized `tile` command, and retires `CoinTileDumpLogging` in favor of the latter.)*
