...
| 4 — **repriced 2026-09-21, `Mars_Gpu.md` §9.1**: three recorded frames decline 150 primitives and every one is two-cycle, none a carry, so this phase is the two-cycle mode and the carry is a smaller question inside it | Two-cycle, and the neighbour carries by whichever of §3's options measures better | Every scene in the threaded suite identical; the serialised share recorded |
