...
| 7 — **the scan-out done 2026-09-21, `Mars_Gpu.md` §13; the last batch and the walk left pending, §14**: all three games at 150% or more at four, and two faster than one for Mario and Ocarina; the average and sharing the image with the frontend not started | Optional: supersampling's average on the device; sharing the image with the frontend instead of readback | Only if phase 6's profile shows the readback or the average as the remaining cost |
