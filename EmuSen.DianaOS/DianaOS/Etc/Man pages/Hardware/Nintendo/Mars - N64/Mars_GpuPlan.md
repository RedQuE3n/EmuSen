...
| 3 — **part one done 2026-09-21, `Mars_Gpu.md` §7**: perspective, the tile, the fetch for every format and size; filtering, the palette and the level of detail remain | Textures: the ring, tile descriptors, all formats and TLUT, filtering, level of detail, perspective | Recorded display lists of the three probe games identical for a frame each |
