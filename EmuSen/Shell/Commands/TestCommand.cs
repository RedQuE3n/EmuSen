...
namespace EmuSen.Shell.Commands
{
    ...
    public class TestCommand : IShellCommand
    {
        ...
        public ShellResult Execute(IDebugTarget? target, string[] args, string? stdin)
        {
            ...
            return result ? ShellResult.Ok("") : ShellResult.Fail("");
        }
    }
    ...
    public class BracketCommand : IShellCommand
    {
        public string Name => "[";
        ...
        public ShellResult Execute(IDebugTarget? target, string[] args, string? stdin)
        {
            ...
            {
                return ShellResult.Fail("Error: '[' must end with a matching ']'.");
            }
