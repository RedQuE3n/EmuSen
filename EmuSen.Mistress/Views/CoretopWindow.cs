...
{
    // The GUI counterpart to DianaOS's own `coretop` command - see `man coretop` for why a window exists alongside the terminal dashboard.
    public class CoretopWindow : PollingWindow
    {
        ...
        // Called by MainWindow whenever the loaded ROM changes - see `man coretop`.
