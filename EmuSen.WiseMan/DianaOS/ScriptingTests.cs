...
namespace EmuSen.WiseMan.DianaOS
{
    ...
    public class ScriptingTests
    {
        ...
        private sealed class TempScript : IDisposable
        {
            ...
            {
                string dir = System.IO.Path.Combine(DianaOSSandbox.ScratchDirectory, "WiseManScriptingTests");
        ...
        {
            string missingPath = Path.Combine(DianaOSSandbox.ScratchDirectory, "WiseManScriptingTests", $"missing_{Guid.NewGuid():N}.txt");
            var shell = DianaOSInterpreter.CreateDefault(null);
