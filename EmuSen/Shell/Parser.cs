...
namespace EmuSen.Shell
{
    ...
    // yet" and is handled entirely inside ShellInterpreter.Submit before
    ...
    // no 'fi' yet isn't broken, it's just not finished. ShellInterpreter
    ...
    public class Parser
    {
        ...
        // never for real expansion (that's ShellInterpreter.ExpandWord's
